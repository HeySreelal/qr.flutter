...
//        paint);
  ...
  void _drawFinderPatternItem(
    ...
    if (eyeStyle.eyeShape == QrEyeShape.square) {
    ...
    } else if (eyeStyle.eyeShape == QrEyeShape.circle) {
      ...
      final roundedOuterStrokeRect = RRect.fromRectAndRadius(
        outerRect,
        Radius.circular(radius * 0.2), // Adjust the corner radius here
      );
      canvas.drawRRect(roundedOuterStrokeRect, outerPaint);

      final roundedInnerStrokeRect = RRect.fromRectAndRadius(
        innerRect,
        Radius.circular(innerRadius * 0.2), // Adjust the corner radius here
      );
      canvas.drawRRect(roundedInnerStrokeRect, innerPaint);

      final roundedDotStrokeRect = RRect.fromRectAndRadius(
        dotRect,
        Radius.circular(dotSize * 0.2), // Adjust the corner radius here
      );
      canvas.drawRRect(roundedDotStrokeRect, dotPaint);
    }
  }
